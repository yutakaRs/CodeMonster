    ...
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-1/2 bg-[#0a0a0a] border-r border-[#1c1c1e] flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <p className="text-[32px] leading-tight font-semibold text-[#fafafa] max-w-md drop-shadow-lg">Get started in seconds.</p>
          <p className="text-[#a1a1aa] mt-4 max-w-sm leading-relaxed drop-shadow-md">Create your account and start managing members with a full-stack Cloudflare application.</p>
        </div>
